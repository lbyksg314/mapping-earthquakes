...
//Deliverable 3: Add 3rd mapbox style tile layer. 
...
d3.json('https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json').then(function(data) {
  ...
  function myStyle(feature){
    ...
    L.geoJson(data, {
      style: myStyle,
      onEachFeature: function(feature, layer){
        console.log(layer); layer.bindPopup('<h3>Name: ' + feature.properties.Name +
        '</h3><hr><h4>Source: '+ feature.properties.Source + '</h4>');
      }
...
//  after the marker has been created and styled. 
  ...
  // 8. Add the major earthquakes layer to the map.
    onEachFeature: function(feature, layer){
      layer.bindPopup('<h2>Magnitude: ' + feature.properties.mag + '</h2><hr><h3>Location: ' 
